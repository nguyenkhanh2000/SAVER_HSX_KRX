...
namespace BaseSaverLib.Implementations
{
    public class CMDDSHandler : IMDDSHandler
    {
        ...
        /// <summary>
        /// 2020-07-30 13:44:46 ngocta2
        /// </summary>
        /// <param name="dataBlock"></param>
        /// <returns></returns>
        //public async Task<EResponseResult> UpdateBulk(string dataBlock)
        //{
        //    TExecutionContext ec = this._app.DebugLogger.WriteBufferBegin($"begin dataBlock={dataBlock}", true);
        //    this.m_SW.Restart();
        ...
        //    {
        //        // get data
        //        string[] rawDataArray = dataBlock.Split(EGlobalConfig.__STRING_RETURN_NEW_LINE_NO_RETURN); //__STRING_RETURN_NEW_LINE

        //        // bo ky tu xuong dong
        //        rawDataArray = this._app.Common.RemoveReturn(rawDataArray);
        //        // build script mssql+oracle
        //        foreach (string rawData in rawDataArray)
        //        {
        //            // bo qua string null / blank
        //            if (!string.IsNullOrEmpty(rawData))
        //            {
        //                string msgType = this._app.Common.GetMsgType(rawData);
                     
        //                count++;
        //                eBulkScript = await ProcessMessage(msgType, rawData);
        //                if (!string.IsNullOrEmpty(eBulkScript.MssqlScript))
        //                    mssqlBuilder.Append(EGlobalConfig.__STRING_RETURN_NEW_LINE + EGlobalConfig.__STRING_EXEC + EGlobalConfig.__STRING_SPACE + eBulkScript.MssqlScript);
        //                if (!string.IsNullOrEmpty(eBulkScript.OracleScript))
        //                    oracleBuilder.Append(EGlobalConfig.__STRING_RETURN_NEW_LINE + EGlobalConfig.__STRING_TAB + EGlobalConfig.__STRING_SPACE + eBulkScript.OracleScript);
        //            }
        //        }
        ...
        //                //    _monitor.SendStatusToMonitor(this._app.Common.GetLocalDateTime(), this._app.Common.GetLocalIp(), CMonitor.MONITOR_APP.HSX_Saver5G
        //                //, this.m_SW.ElapsedMilliseconds);
        //                _redis.SendStatusToMonitor_2(this._app.Common.GetLocalDateTime(), this._app.Common.GetLocalIp(), CRedisClient.MONITOR_APP.HSX_Saver5G
        //                   , count
        //                   , this.m_SW.ElapsedMilliseconds, _redisConfig.Host_FOX, _redisConfig.Port_FOX, _redisConfig.Host_LLQ, _redisConfig.Port_LLQ);
        //            }
        //            else
        //            {
        //                // exec script mssql
        //                await this._repository.ExecBulkScript(mssqlBuilder.ToString());
        //                //    _monitor.SendStatusToMonitor(this._app.Common.GetLocalDateTime(), this._app.Common.GetLocalIp(), CMonitor.MONITOR_APP.HSX_Saver5G
        //                //, count
        //                //, this.m_SW.ElapsedMilliseconds);
        //                _redis.SendStatusToMonitor_2(this._app.Common.GetLocalDateTime(), this._app.Common.GetLocalIp(), CRedisClient.MONITOR_APP.HSX_Saver5G
        ...
        //        // return data
        //        return new EResponseResult() { Code = errorCode, Message = "", Data = null };
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //        // return null
        //        return new EResponseResult() { Code = EGlobalConfig.__CODE_ERROR_IN_LAYER_BLL, Message = ex.Message, Data = null };
        //    }
        //}
